...
const Impact = () => {
  return (
    <section id="impact" className="relative py-24 overflow-hidden" aria-labelledby="impact-heading">
      {/* Background Image */}
      <div className="absolute inset-0 z-0">
        <img 
          src={techGirlImage} 
          alt="African woman in technology representing innovation and digital transformation" 
      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="max-w-3xl mx-auto text-center mb-16 animate-fade-in">
          <h2 id="impact-heading" className="font-heading text-4xl md:text-5xl mb-6 text-white">
